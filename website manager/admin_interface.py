...
def upload_image(img_file, img_name):
    ...
    update.repo.create_file(
        git_file, "committing image file", img_file, branch="main")
...
class File():
    ...
    def get_img(self):
        try:
            ...
            self.photographer = askstring(
                "Photography Credits", "Enter name of the photographer")
            ...
            update.repo.create_file(
                git_file, "committing image file", bytes(bytearray(f)), branch="main")
    ...
    def __init__(self, next, back, selected_idx):
        ...
        self.img_filename = self.selected_file.get_img(
            contents)[0: len(self.selected_file.get_img(contents)) - 1]
        ...
        self.type_l = Label(main, text="   Type",
        ...
        self.month_opt = ["January", "Febuary", "March", "April", "May", "June",
        ...
        self.issue_l = Label(main, text="   Issue",
                             font=("Helvetica", 10, "bold"))
        ...
        self.author_l = Label(main, text="  Author",
                              font=("Helvetica", 10, "bold"))
        self.author_entry = Text(
            main, height=1, width=45, font=("Helvetica", 10, "normal"))
        ...
        self.title_l = Label(main, text="Title",
                             font=("Helvetica", 10, "bold"))
        self.title_entry = Text(main, height=1, width=45,
        ...
        self.sub_l = Label(main, text="Subtitle",
                           font=("Helvetica", 10, "bold"))
        self.sub_entry = Text(main, height=1, width=45,
                              font=("Helvetica", 10, "normal"))
        ...
        self.getimage_btn = Button(
            main, text="Replace Image", bg="white", font=("Helvetica", 9, "normal"))
        ...
        self.body_entry = scrolledtext.ScrolledText(
            main, height=8, width=45, font=("Helvetica", 10, "normal"))
...
class View():
    ...
    def next_btn(self):
        self.view_delete()
        selected_idx = int(str(self.article_listbox.curselection())[
                           1: len(str(self.article_listbox.curselection())) - 2])
    ...
    def delete_btn(self):
        ...
        confirmation = askyesno(
            title='Delete File', message='Are you sure that you want to delete the file?')
        ...
        if confirmation:
            ...
            filecontent = str(selected_idx.get_contents(filepath).decoded_content.decode())[0:str(
                update.repo.get_contents(filepath).decoded_content.decode()).index("name=\"genre\"/>")]
    ...
    def __init__(self, next, back):
        ...
        self.article_listbox = Listbox(
            self.frame, selectmode="single", width=55, height=13)
        index = 0
        ...
        self.scrollbar = Scrollbar(
            self.frame, command=self.article_listbox.yview)

        self.delete_btn = Button(main, text="Delete File", command=self.delete_btn, bg="white", font=(
            "Helvetica", 9, "normal"), width=50)
...
class NewTextBased():  # new text based article
    ...
    def __init__(self, next, back):
        ...
        self.getimage_btn = Button(
            main, text="Image File", bg="white", font=("Helvetica", 9, "normal"))
...
class Comic():
    ...
    def get_img(self):
        try:
            ...
            # get photographer name and generate filename
            messagebox.showinfo(
                "Information", "Image file sucessfully uploaded")
            self.img_filename = str(
                datetime.datetime.now().strftime("%f")) + ".jpg"
...
class Main():
    ...
    def __init__(self):
        ...
        self.ViewButton = Radiobutton(main, text="View all files",
                                      ...
                                      width=20,
                                      font=("Helvetica", 12, "normal"))
        self.AddButton = Radiobutton(main, text="Add downloadble links",
                                     variable=self.opt_main,
                                     value=3,
                                     height=1,
                                     width=20,
        ...
        self.next = Button(main, text="Next",
                           command=self.next_btn, bg="white",
