    ...
    <body class="flex flex-col min-h-screen">
        ...
        <div>
            ...
            <div class = "nav_bar" style = "padding-left: 150px; padding-right: 150px">
                <a href = "index.html">
                    <img class = "nav_bar" style = "padding-left: 10px;" src = "images/riverdale spectator logo crop.jpg" alt = "riverdale spectator logo">
                </a>
                <div style = "margin-top: 70px; margin-right: 130px; display:inline-block; position: absolute; right: 0; background-color: white;">
                    <svg class="w-6 h-6" style = "padding: 2px;color: black; display:inline-block;" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                    <input id = "searchbar" type="text" onkeyup="searchbar()" onfocusout = "hide()" class = "nav_bar shadow-md" style = "color: black" placeholder="Search..." >
                    
                    <div id = "searchdrop" style = "box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;" >
                        <div id = "searchlist" class = "hidden" aria-labelledby="dropdownDefault">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!--main icons-->
            <div style = "font-size: 13px;padding-top: 15px; padding-left: 160px; padding-bottom: 15px; background-color: #28282B; color: white">
                <a href="index.html" style = "padding-right: 20px" class="font-medium hover:underline">HOME</a>
                <a href="news.html" style = "padding-right: 20px" class="font-medium hover:underline">NEWS</a>
                <a href="opinion.html" style = "padding-right: 20px" class="font-medium hover:underline">OPINION</a>
                <a href="critic.html" style = "padding-right: 20px" class="font-medium hover:underline">CRITIC'S CORNER</a>
                <a href="c&i.html" style = "padding-right: 20px" class="font-medium hover:underline">CULTURE & ILLUSTRATIONS</a>
                <a href="puzzles.html" style = "padding-right: 20px" class="font-medium hover:underline">PUZZLES & GAMES</a>
            </div>
 </div>"""

BOTTOM_NAV = """
        <!--bottom navigation bar-->
        <div class = "mt-auto bottom_bar" style = "padding-left: 160px; padding-right:160px"> 
            <div class="grid grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <a href = "news.html" class = "hover:underline">News</a><br>
                    <a href = "opinion.html" class = "hover:underline">Opinion</a><br>
                    <a href = "critic.html" class = "hover:underline">Critic's Corner</a><br>
                    <a href = "c&i.html" class = "hover:underline">Culture & Illustrations</a>
                </div>
    
                <div>
                    <h1 class = "font-bold">QUICK LINKS</h1>
                    <a href = "bookreviews.html" class = "hover:underline">Book Reviews</a><br>
                    <a href = "bookreviews.html" class = "hover:underline">Movie Reviews</a><br>
                    <a href = "stories.html" class = "hover:underline">Short Stories</a><br>
                    <a href = "horoscopes.html" class = "hover:underline">Horoscopes</a><br>
                    <a href = "comics.html" class = "hover:underline">Comics</a>
                </div>
            </div>
            ...
            <div style = "padding-top: 30px"> 
                ...
                <div style = "padding-bottom: 30px; float:right">
                    <a id = "instagram" style = "display:inline-block" href = "#" target="_blank">
                    ...
                    <a id = "email" style = "display:inline-block" href = "#">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48"><path fill="#1e88e5" d="M34,42H14c-4.411,0-8-3.589-8-8V14c0-4.411,3.589-8,8-8h20c4.411,0,8,3.589,8,8v20 C42,38.411,38.411,42,34,42z"></path><path fill="#fff" d="M35.926,17.488L29.414,24l6.511,6.511C35.969,30.347,36,30.178,36,30V18 C36,17.822,35.969,17.653,35.926,17.488z M26.688,23.899l7.824-7.825C34.347,16.031,34.178,16,34,16H14 c-0.178,0-0.347,0.031-0.512,0.074l7.824,7.825C22.795,25.38,25.205,25.38,26.688,23.899z M24,27.009 c-1.44,0-2.873-0.542-3.99-1.605l-6.522,6.522C13.653,31.969,13.822,32,14,32h20c0.178,0,0.347-0.031,0.512-0.074l-6.522-6.522 C26.873,26.467,25.44,27.009,24,27.009z M12.074,17.488C12.031,17.653,12,17.822,12,18v12c0,0.178,0.031,0.347,0.074,0.512 L18.586,24L12.074,17.488z"></path></svg>
                    </a>
                    <a id = "github" style = "display:inline-block" href = "#" target="_blank">
                        <svg style = "padding-top: 50px; width: 50px;" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 100 100"> <circle cx="52" cy="52" r="44" opacity=".35"></circle><circle cx="50" cy="50" r="44" fill="#f2f2f2"></circle><path fill="#707cc0" d="M50,12.5c-20.711,0-37.5,16.789-37.5,37.5S29.289,87.5,50,87.5S87.5,70.711,87.5,50 S70.711,12.5,50,12.5z"></path><path fill="#f2f2f2" d="M60.161,83.936c0-1.122,0.042-4.813,0.042-9.389c0-3.192-1.095-5.281-2.324-6.338 c7.624-0.847,15.626-3.74,15.626-16.888c0-3.736-1.324-6.791-3.518-9.184c0.352-0.866,1.527-4.346-0.341-9.057 c0,0-2.868-0.92-9.402,3.508c-2.734-0.759-5.662-1.139-8.568-1.152c-2.91,0.013-5.838,0.393-8.568,1.152 c-6.538-4.429-9.411-3.508-9.411-3.508c-1.862,4.712-0.687,8.192-0.336,9.057c-2.189,2.393-3.523,5.448-3.523,9.184 c0,13.115,7.99,16.051,15.589,16.915c-0.978,0.856-1.862,2.364-2.173,4.575c-1.95,0.876-6.907,2.386-9.96-2.844 c0,0-1.808-3.285-5.242-3.527c0,0-3.342-0.043-0.235,2.08c0,0,2.244,1.053,3.8,5.006c0,0,2.009,6.656,11.529,4.588 c0.017,2.856,0.046,5.008,0.046,5.821c0,0.385-0.122,0.792-0.383,1.115C45.945,86.292,49.3,87,52.807,87 c2.981,0,5.853-0.509,8.576-1.417C60.502,85.37,60.161,84.613,60.161,83.936z"></path><path fill="#40396e" d="M50,89c-21.505,0-39-17.495-39-39s17.495-39,39-39s39,17.495,39,39S71.505,89,50,89z M50,14 c-19.851,0-36,16.149-36,36s16.149,36,36,36s36-16.149,36-36S69.851,14,50,14z"></path> </svg>        
                    </a>
                </div>
            </div>
        </div>
