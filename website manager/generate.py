 ...
 <div class="mt-auto bottom_bar" onclick = "reset_search()" style="padding-left: 160px; padding-right:160px">
  <div class="grid grid-cols-4 gap-4">
   ...
   <div>
    ...
    <a class="hover:underline" href="bookreviews.html">
     Book Reviews
    </a>
    <br/>
    <a class="hover:underline" href="bookreviews.html">
    ...
    <br/>
    <a class="hover:underline" href="stories.html">
     Short Stories
    </a>
    <br/>
    <a class="hover:underline" href="horoscopes.html">
     Horoscopes
    </a>
    <br/>
    <a class="hover:underline" href="comics.html">
     Comics
    </a>
   </div>
  </div>
